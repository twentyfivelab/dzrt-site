...
export const SITE_DESCRIPTION =
  "DZRT. conçoit des sites internet, des identités de marque et des stratégies de visibilité en ligne pour les entreprises et indépendants qui veulent inspirer confiance dès le premier regard.";

export const CONTACT_EMAIL = "contact@dzrt.com";
